 ...
 */
package br.com.dev.engine.date;
...
public abstract class Datas {
    ...
    public static boolean isBetween(LocalTime horario, LocalTime inicio, LocalTime fim) {
        return ((inicio.equals(horario) || inicio.isBefore(horario)) && (fim.equals(horario) || fim.isAfter(horario)));
    }

    public static boolean isBetween(LocalTime horario, String inicio, String fim) {
        return isBetween(horario, Datas.stringToLocalTime(inicio), Datas.stringToLocalTime(fim));
    }
